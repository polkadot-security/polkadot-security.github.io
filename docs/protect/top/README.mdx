...
The Top Ten vulnerabilities are in constant evolution, new vulnerabilities may be added to the list, and existing ones may be moved to the [Polkadot Base](/docs/protect/base) as they become less common.
