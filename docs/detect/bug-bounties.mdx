...
The bridge between Polkadot and Ethereum is covered by the Snowbridge Bug Bounty program. Current scope includes:

- Parity Bridges Common
- Polkadot SDK Bridges
- Bridge Hub Parachain Runtimes (Polkadot SDK)
- Bridge Hub Parachain Runtimes (Fellowship)
- Asset Hub Parachain Runtimes (Polkadot SDK)
- Asset Hub Parachain Runtimes (Fellowship)
- Ethereum Contracts

Find more details on the [Snowbridge Bug Bounty program](https://hackenproof.com/programs/snowbridge-on-chain-code).
